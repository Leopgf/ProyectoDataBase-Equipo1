...
class EditarFuncion extends Component {
  state = {
    funcion: {
      fecha: "",
      hora: "",
  ...
  componentDidMount() {
    ...
    axios.get(`http://localhost:8000/api/funciones/${this.props.match.params.id_funcion}`).then((res) => {
    ...
    return (
      <div className="row justify-content-center">
        <div className="col-12">
          ...
          <h3 className="mt-3 text-center">EDITAR FUNCIÓN</h3>
        </div>
        <div
            ...
            <div className="m-5">
              ...
              <Form.Group className="d-flex justify-content-center">
                <Button
                  ...
                  onClick={this.handleEditarFuncion.bind(this)}
                >
                  EDITAR
                </Button>
              </Form.Group>
