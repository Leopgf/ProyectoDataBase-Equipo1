          ...
          <div className="row">
            ...
            </div>
            {
              this.state.combos.map(combo =>
                <div className="col-xs-12 col-sm-12 col-md-6 col-xlg-4 text-center mt-3 mb-3" style={{ display:'flex', justifyContent:'center' }} key={combo.id}>  {/* RESPONSIVE COMBOS*/}
                    <Card border="dark" style={{ width: '25rem' }}>
                    <Card.Header className="font-weight-bold" style={{ fontSize: '20px' }}>{ combo.nombre }</Card.Header>
                    <Card.Body>
