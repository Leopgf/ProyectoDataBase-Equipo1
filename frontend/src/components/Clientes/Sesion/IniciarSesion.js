                ...
                <div className="col-12 mt-2 ml-1" style={{ display:'flex', justifyContent:'center' }}>
                        <Form>
                            <Form.Group controlId="formBasicEmail">
                                ...
                                <Form.Text className="text-muted">Recuerde que el Usuario es el número de su Cédula de Identidad</Form.Text>
                            </Form.Group>
                            ...
                            <Link to={`/registro`}><Button variant="outline-info" style={{ width: '100%'}} type="submit">Registrarse</Button></Link>
                    </Form>
                </div>
            </div>
